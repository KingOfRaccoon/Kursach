...
//                    list.data?.links = http.data.links
    ...
    private fun convertWeekToDays(
        ...
        return addDaysWithoutLessons(mapDays).also {
            println("convertWeekToDays")
            it.forEach { t, u ->
                println(t)
                println(u)
            }
    ...
    fun createUser(login: String, password: String, firstName: String, secondName: String) =
        databaseFactory.createUser(login, password, firstName, secondName)
